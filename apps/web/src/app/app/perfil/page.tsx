    ...
    <main className='space-y-4'>
      <section className='rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6'>
        <div className='flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between'>
          ...
          <button
            type='button'
            className='inline-flex cursor-not-allowed items-center rounded-lg border border-slate-200 bg-slate-100 px-3 py-2 text-sm font-medium text-slate-500'
            disabled
            title='Edição de perfil será disponibilizada no próximo bloco.'
          >
            Editar perfil (breve)
          </button>
        </div>
